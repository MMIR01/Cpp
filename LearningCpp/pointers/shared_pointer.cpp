 ...
 * a lvalue reference to shared pointers
************************************/
...
int main (){
    ...
    std::cout << "Shared pointer reference address: " << refHouse.getAddress() << ", " << refHouse.getPostCode() << "\n";
    ...
    */
    ...
    /* What happens when we modified the shared pointer referenced?
    ...
    * In this case, what happens when the following sentence is executed?*/ 
    ...
    //The first shared pointer is still pointing out at the Cars 222
    std::cout << "Shared pointer address: " << myHouseOwner1_p->getAddress() << ", " << myHouseOwner1_p->getPostCode() << "\n";
